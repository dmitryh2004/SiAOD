// siaod_p2_5_redblack_tree.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
	...
	RedBlackTree tree = RedBlackTree(new RedBlackTreeNode(nullptr, stoull(string(temp.phone)), 1, Black));
	int i = 2;
	...
	while (running)
	{
		...
		case 'a':
			...
			cin >> recordIndex;
			if ((BinFileEditor::readByIndex(recordIndex, temp)) && (strcmp(temp.phone, "")))
			{
